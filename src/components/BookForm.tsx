...
export default function BookForm() {
  return (
    <div className="w-full lg:h-[75px]">
      <div className="relative container px-0 h-[75px]">
        <form
          action=""
          className="lg:absolute lg:-top-1/2 lg:z-20 mt-7 lg:mt-0 w-full bg-secondary flex flex-col lg:flex-row lg:h-[75px] lg:px-0 px-5 lg:mx-auto"
        >
          ...
          />
          <Button variant={"accent"} className="h-full w-full">
            check now
          </Button>
        </form>
      </div>
